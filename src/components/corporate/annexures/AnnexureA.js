...
const drawDirector = (
  ...
  // Designation
  page.drawText(`Designation: ${director.designation}`, {
    x: 50,
    y: y - lineHeight,
    font: regularFont,
    size: 10,
  ...
  // Seal area
  page.drawText("(Specimen signature with seal)", {
    x: columnWidth * 2 - 25,
    y: sealEndY - 20,
    font: regularFont,
    size: 10,
...
export const generateAnnexureAPdf = async (
  ...
  const noteText =
    "NOTE: Should contain photographs of all Directors of the Company (Please add or request for more space/pages for more Directors, if required)";
  ...
  const addNewPage = () => {
    ...
    centerText(
      currentPage,
      "ANNEXURE A: LIST OF ALL DIRECTORS OF THE COMPANY WITH PHOTOGRAPHS AND SIGNATURES",
      A4_HEIGHT - 100,
      10,
      regularFont
    );
