...
export const generateShareholdingPatternPdf = async (
  ...
  centerText(
    page,
    "Latest Shareholding of the LLP",
    A4_HEIGHT - 150,
    14,
    boldFont
  );
  ...
  const noteText =
    "NOTE: If any LLP is a shareholder of the applicant, having more than 15% of shareholding or capital or profits of the applicant, it should identify itself as an ultimate beneficiary and is required to beverified by obtaining self-attested copies of the KYC documents of the Partner/Individual Promoters of such a LLP.";
  ...
  page.drawText(
    `On Behalf Of ${corporateData.value.corporateName} [Name of LLP]`,
    {
      x: 50,
      y: companyBehalfY,
      size: 10,
  ...
  page.drawText(`(Sign & Seal of the LLP)`, {
    x: 50,
    y: sealEndY - 20,
    size: 10,
    font: regularFont,
